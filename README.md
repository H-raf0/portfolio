...
- Project links to public GitHub repositories
- Scroll-driven visual experience built with React, Vite, Framer Motion, and Lenis
- Static deployment with a mailto-based contact form—no backend required
